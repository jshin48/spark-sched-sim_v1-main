...
class TPCHDataSampler(BaseDataSampler):
    ...
    def _rough_task_duration(cls, task_duration_data):
        ...
        return np.mean(all_durations) #average duration for the specific stage
    ...
    def _sample_job(self, job_id, t_arrival):
        ...
        #calculate cpt
        cpt, num_children = self._get_node_feature(task_duration_data, adj_mat)
        ...
        for stage_id in range(num_stages):
            ...
            # generate a node
            stage = Stage(stage_id, job_id, num_tasks, self._rough_task_duration(data),cpt[stage_id], num_children[stage_id])
    ...
    def _get_node_feature(self, task_duration_data, adj_mat):
