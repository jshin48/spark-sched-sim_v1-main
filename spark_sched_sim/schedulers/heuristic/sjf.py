...
class SjfScheduler(HeuristicScheduler):
    ...
    def schedule(self, obs):
        ...
        schedulable_stages = {
            global_idx: sched_idx
            for sched_idx, global_idx in enumerate(stage_mask.nonzero()[0])
        }
        ...
        if not candidate_jobs:
            return {"stage_idx": -1, "num_exec": num_committable_execs - 1}
