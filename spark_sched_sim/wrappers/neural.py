...
class NeuralObsWrapper(ObservationWrapper):
    ...
    def __init__(self, env, num_tasks_scale=200, work_scale=1e5):
        ...
        self.observation_space = sp.Dict(
            {
                "dag_batch": sp.Graph(
                    node_space=sp.Box(-np.inf, np.inf, (self.NUM_NODE_FEATURES,)),
    ...
    def observation(self, obs):
        ...
        obs = {
            ...
            "exec_mask": exec_mask,
            "exec_supplies": exec_supplies, #JS added
            "source_job_idx": j_src, #JS added
            "num_committable_execs": num_committable_execs, #JS added
            "DRA_exec_cap": obs["DRA_exec_cap"] #JS added
        }
